            ...
            <div class="main-carousel default">
                <div id="myCarousel" class="carousel slide">
                    <div class="carousel-inner">
                        <div class="item parallax" style='background-image:url({{asset("../public/../public/images/vm-4.jpeg")}});'>
                            <div class="container">
                                <div class="fly-itable">
                                    <div class="fly-icell">
                                        <div class="fly-wrap-text-slider">
                                            <h1 class="fly-slider-title-before">VILA MADALENA</h1>
...
object-fit: cover !important; }</style>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="fly-info-box-content" style="font-weight: bolder; text-align: justify;"> O bairro mais boêmio de São Paulo recebe em um único lugar o melhor da <span style="color: #efa35c;">gastronomia contemporânea</span>, coquetelaria, arte e lazer. Com a mesma inspiração da primeira unidade na Avenida Juscelino Kubistchek, o  <span style="color: #efa35c;">B.A.R. Vila Madalena</span> traz muita agitação, boa música, exposições com novos artistas, <span style="color: #efa35c;">drinks</span> autorais e <span style="color: #efa35c;">muita gente bonita</span>.
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <section class="fly-home-gallery">
            ...
            <div class="fly-home-gallery-col col-sm-4">
                <div class="fly-home-gallery-block fly-home-gallery-height-md" style="background-image: url('../public/images/vm-1.jpeg')">
                    <a href="../public/images/vm-1.jpeg" data-rel="prettyPhoto[1]" class="fly-home-gallery-overlay">
                        <div class="fly-itable">
                            <div class="fly-icell">
                ...
                <div class="fly-home-gallery-block fly-home-gallery-height-md" style="background-image: url('../public/images/vm-2.jpeg')">
                    <a href="../public/images/vm-2.jpeg" data-rel="prettyPhoto[1]" class="fly-home-gallery-overlay">
                        <div class="fly-itable">
                            <div class="fly-icell">
                                <i class="flyicon-expand"></i>
                            </div>
                ...
                <div class="fly-home-gallery-block fly-home-gallery-height-md" style="background-image: url('../public/images/vm-4.jpeg')">
                    <a href="../public/images/vm-4.jpeg" data-rel="prettyPhoto[1]" class="fly-home-gallery-overlay">
                        <div class="fly-itable">
                            <div class="fly-icell">
                                <i class="flyicon-expand"></i>
                            </div>
            ...
            <div class="fly-home-gallery-col col-sm-4">
                <div class="fly-home-gallery-block-title fly-home-gallery-height-md">
                    <div class="fly-itable">
                        <div class="fly-icell">
                            <h5 class="fly-home-gallery-before-title"><span>VILA MADALENA</span></h5>
                ...
                <div class="fly-home-gallery-block fly-home-gallery-height-lg" style="background-image: url('../public/images/vm-7.jpeg')">
                    <a href="../public/images/vm-7.jpeg" data-rel="prettyPhoto[1]" class="fly-home-gallery-overlay">
                        <div class="fly-itable">
                            <div class="fly-icell">
                                <i class="flyicon-expand"></i>
                            </div>
            ...
            <div class="fly-home-gallery-col col-sm-4">
                <div class="fly-home-gallery-block fly-home-gallery-height-md" style="background-image: url('../public/images/vm-5.jpeg')">
                    <a href="../public/images/vm-5.jpeg" data-rel="prettyPhoto[1]" class="fly-home-gallery-overlay">
                        <div class="fly-itable">
                            <div class="fly-icell">
                                <i class="flyicon-expand"></i>
                            </div>
                ...
                <div class="fly-home-gallery-block fly-home-gallery-height-md" style="background-image: url('../public/images/vm-6.jpeg')">
                    <a href="../public/images/vm-6.jpeg" data-rel="prettyPhoto[1]" class="fly-home-gallery-overlay">
                        <div class="fly-itable">
                            <div class="fly-icell"><i class="flyicon-expand"></i></div>
                        </div>
                    </a>
                </div>
                <div class="fly-home-gallery-block fly-home-gallery-height-md" style="background-image: url('../public/images/vm-3.jpeg')">
                    <a href="../public/images/vm-3.jpeg" data-rel="prettyPhoto[1]" class="fly-home-gallery-overlay">
                        <div class="fly-itable">
                            <div class="fly-icell"><i class="flyicon-expand"></i></div>
                        </div>
                    </a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="fly-info-box-content col-md-5" style="font-weight: bolder; text-align: justify;">
                        ...
                        <div class="fly-info-box-header"><!--<h5 class="fly-info-box-before-title"><span>Carmelo</span></h5>-->
                              <div class="text-center">
                                  <a target="_blank" href="../public/downloads/cardapio-vm-comidas.pdf" class="fly-btn fly-btn-lg fly-btn-1 fly-btn-color-2">Cardápio Comidas</a>
                              </div>
                        </div>
                        <div class="row">
                            <div class="fly-divider-space space-sm"></div>
                    ...
                    <div class="fly-info-box-content col-md-6" style="font-weight: bolder; text-align: justify;">
                        ...
                        <div class="fly-info-box-header"><!--<h5 class="fly-info-box-before-title"><span>Carmelo</span></h5>-->
                              <div class="text-center">
                              <a target="_blank" href="../public/downloads/cardapio-vm-drinks.pdf" class="fly-btn fly-btn-lg fly-btn-1 fly-btn-color-2">Cardápio Drinks</a>
                              </div>
                        </div>
                        <div class="row">
                            <div class="fly-divider-space space-sm"></div>
