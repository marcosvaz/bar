...
function scrollTo360(){
    $('html,body').animate({scrollTop: $(".fly-home-gallery").offset().top - 96},'normal');
}
if(url.indexOf("php") != -1){
    $('#bar').click(function(){
        location.href="/#load-stuff";
    });
}else{
    $('#bar').click(function(){
        scrollTo360();
...
if(window.location.hash === "#load-stuff"){
    $(window).load(function(){
        setTimeout(function(){scrollTo360()} , 500);
    });
}
...
jQuery(document).ready(function() {
    ...
    jQuery('.fly-form-contact').on("submit", function(){
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                form_parent.append('<h3>Sua mensagem foi enviada!</h3><div class="confirm"><p class="textconfirm">Obrigado por nos contactar.<br/>Nós iremos responde-lo assim que possível.</p></div>');
            },
            fail: function () {
                console.log('fail');
                form_parent.find('form').hide();
    ...
    //             form_parent.find('form').hide();
    //             form_parent.find('.fly-contact-title').hide();
    //             form_parent.append('<h3>Aguarde o contato de nossa equipe confirmando sua reserva!</h3><div class="confirm"><p class="textconfirm">Obrigado por nos contactar.</p></div>');
    //         },
    //         fail: function () {
    ...
    $('#CarouselEspecialidades').carousel({
        interval: 2000
    });
    ...
    if (Modernizr.touch) {
        ...
        $('#CarouselEspecialidades').find('.carousel-inner').swipe( {
            swipeLeft: function() {
                $(this).parent().carousel('next');
            },
            swipeRight: function() {
...
/*     var Mobile_Menu = function() {
        ...
        if(jQuery('.fly-site-navigation#fly-menu-secondary').length > 0) {console.log('if');
    ...
    function init() {
        var myLatLong = new google.maps.LatLng(-23.5893517, -46.6768133);  // Set coordinates for map
